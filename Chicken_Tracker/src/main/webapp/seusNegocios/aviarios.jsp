        ...
        <div class="modal-dialog modal-notify modal-danger" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button form="checks" formaction="/Chicken_Tracker/LocalAvesServlet" formmethod="post" name="aviario" value="excluir" type="submit" class="btn btn-danger">Confirmar</button>
                </div>
            </div>
        </div>
    </div>
